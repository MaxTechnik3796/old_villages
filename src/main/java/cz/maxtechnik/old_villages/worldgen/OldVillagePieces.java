...
public class OldVillagePieces {
    ...
    public static class VillagePiece extends StructurePiece {
        ...
        public VillagePiece(int pieceType, int x, int y, int z, Direction orientation) {
            super(OldVillagesMod.OLD_VILLAGE_PIECE.get(), x, y, z, 6, 12, 6, orientation);
            this.pieceType = pieceType;
            this.setOrientation(orientation);
            
            // Nastavení bounding boxu podle rotace (moderní náhrada starého složitého přepočtu)
            this.boundingBox = BoundingBox.orientBox(x, y, z, 0, 0, 0, 6, 12, 6, orientation);
        }
